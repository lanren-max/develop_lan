...
xSQL = xSQL + "          (IF (PaymentCharged - PaymentRefund = 0, 0, LineTaxTotal)) + pladjustment as GrossProfit_POs, " 
xSQL = xSQL + "  PaymentCharged - PaymentRefund - "
xSQL = xSQL + "  (IF (RMAid = 0, (AverageCost*QtyShipped) , " 
xSQL = xSQL + "    IF (rmaQtyReceived <> 0 , (AverageCost*QtyShipped)-(rmaQtyReceived*AverageCost) , " 
xSQL = xSQL + "              (AverageCost*QtyShipped) ))) - FinalShippingFee - ComissionTotalxItem - " 
xSQL = xSQL + "          CoOpFee - PaypalFeeTotal -  "
xSQL = xSQL + "          (IF (PaymentCharged - PaymentRefund = 0, 0, LineTaxTotal)) + pladjustment as GrossProfit_Avg, " 
